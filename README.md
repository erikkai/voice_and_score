...
> **LEGACY PROJECT:** This is an old demo that showcases one of the projects that won an innovation award during TeleSign's hackathon. 
...
If a caller's score is low enough, the caller makes it into a mini Interactive Voice Response (IVR) system where you can choose from a menu whether to call option 1 or option 2. You can change up what's included in the system using TeleSign's Voice API documentation, provided here: <!-- [Dead Link, no replacement available](https://enterprise.telesign.com/api-reference/apis/voice) -->
...
NOTE: TeleSign's legacy Voice API <!-- [Dead Link, no replacement available](https://enterprise.telesign.com/legacy-products/voice-api/overview) --> cannot be used for this project. 
...
4. For auth_key put in the Basic Authentication version of your customer ID and API key. You can read more about setting up Basic Authentication here - <!-- [Dead Link, no replacement available](https://enterprise.telesign.com/api-reference/authentication#basic-authentication) -->
